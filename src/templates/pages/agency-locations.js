    ...
    <Layout className="overflow-x-hidden break-all">
      ...
      >
        <div className="flex flex-col justify-center items-center gap-y-8 ml-6 lg:ml-32 my-16">
          <div className="text-themeBlue-600 text-2xl lg:text-7xl font-Raleway font-bold text-center">
            Get A FREE SEO <br />
            Proposal
          </div>
          <div className="text-themeOrange-400 text-sm lg:text-4xl font-RalewayLight text-center">
            Chicago SEO Company{" "}
          </div>
          <Link
            to="/search-marketing-website-design-proposal-form"
            className="bg-themeOrange-400 font-Lusitana text-white uppercase text-xs lg:text-base rounded px-6 py-3"
          >
      ...
      <div className="w-11/12 mx-auto flex flex-col lg:flex-row gap-y-5 lg:gap-x-5 py-8">
        <div className="flex-1">
          <p className="pb-3 text-themeGray-200 text-lg font-Raleway mx-auto">
          ...
          <p className="pb-8 text-themeGray-200 text-lg font-Raleway mx-auto">
      ...
      <div className="bg-themeOrange-400">
        <div className="w-11/12 mx-auto flex flex-col lg:flex-row gap-y-5 lg:gap-x-8 py-12">
          ...
          />
          <div className="flex-1">
            <h2 className="font-Raleway text-3xl text-white underline pb-5">
              Our Team Works to Provide Your Business With:
            </h2>
            <ul className="font-Raleway text-lg text-white">
            ...
            <Link
              to="/about/"
              className="bg-themeBlue-600 font-Lusitana text-white uppercase text-xs lg:text-base rounded px-6 py-3"
            >
              Meet The Team
            </Link>
          </div>
      ...
      <div className="w-11/12 mx-auto py-12">
        ...
        <h2
          className="font-Raleway text-3xl underline pb-5 text-center"
        ...
        <ul className="font-Raleway text-lg">
          <li className="flex gap-x-3 items-center pb-3">
            <GatsbyImage
              image={checkMark?.childImageSharp?.gatsbyImageData}
              alt="Blue Check Mark"
        ...
        <div className="flex flex-col gap-y-5 lg:flex-row lg:gap-x-5 lg:gap-y-0 items-center">
          <div className="flex-1">
            ...
            <ul className="font-Raleway text-lg list-disc list-inside">
              <li className="pb-3">
      ...
      <div className="bg-themeOrange-400 text-white text-center py-16">
        <div className="font-Raleway text-xl lg:text-3xl pb-5">
          Ready to see how our Chicago-based SEO company helps grow your leads
          and sales?
        </div>
        <p className="font-Raleway text-xl pb-5">Get a FREE proposal!</p>
        <Link
          to="/search-marketing-website-design-proposal-form"
          className="bg-themeBlue-600 font-Lusitana text-white uppercase text-xs lg:text-base rounded px-6 py-3"
        >
      ...
      <div className="w-11/12 mx-auto py-10">
        ...
        <p className="w-8/12 mx-auto font-Raleway text-lg text-center pb-5">
      ...
      <div className="bg-themeOrange-400 text-white text-center py-16">
        <div
          className="font-Raleway text-xl lg:text-3xl pb-5 underline"
          style={{ textDecorationColor: "#00497a" }}
        >
          Get Started to Achieve Higher Keyword Rankings, More Traffic and Leads
        </div>
        <p className="w-7/12 mx-auto font-Raleway text-sm lg:text-lg pb-5">
