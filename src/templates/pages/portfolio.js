  ...
  return (
    <Layout>
      ...
      <BackgroundImage
        ...
        id="WebDesignPage"
        className="w-full text-gray-800 font-RalewayBlack py-20 border-b-4 border-themeGray-50 shadow-themeShadow mb-8"
      >
        <div className="pl-24 lg:pl-96 flex flex-col gap-y-10">
          <div className="text-themeBlue-600 mt-20 text-2xl lg:text-7xl font-Raleway font-bold text-center">
      ...
      <div className="w-11/12 mx-auto">
        <h1 className="text-themeOrange-400 text-5xl font-Raleway font-bold tracking-wide text-center pb-5">
      ...
      <div className="py-8">
        ...
        <div className="py-10">
          {/* <ul className="w-11/12 mx-auto grid grid-cols-1 lg:grid-cols-2 lg:gap-x-3 justify-evenly items-center text-base font-Raleway"> */}
          <Swiper
            navigation
