    ...
    <Layout className="overflow-x-hidden break-all">
      ...
      <div>
        ...
        <div className="w-11/12 mx-auto flex flex-col lg:flex-row gap-y-5 lg:gap-x-5 py-8">
          ...
          <div className="w-full mt-5 lg:mt-0 mx-auto font-Lusitana text-themeGray-300">
            <h2 className="font-Lusitana text-2xl text-themeBlue-600 pb-5">
      ...
      <BackgroundImage
        ...
        preserveStackingContext
        id="parallax-section"
        className="w-full bg-fixed bg-blend-darken text-white text-center font-RalewayBlack flex flex-col gap-y-8 justify-center items-start"
      >
        <div className="mx-auto flex flex-col justify-center items-center gap-y-8 my-8">
          <div className="font-Raleway font-bold text-5xl text-white py-5">
            ABOUT SEARCH MARKETING RESOURCE, LLC
          </div>
          <div className="text-sm lg:text-2xl font-Raleway text-white italic">
