  ...
  return (
    <Layout className="overflow-x-hidden break-all">
      ...
      <div className="w-11/12 mx-auto">
        <h1 className="font-Raleway font-bold text-5xl text-themeOrange-400 text-center py-8">
        ...
        <p className="pb-3 text-themeGray-200 text-lg font-Raleway mx-auto uppercase">
