    ...
    <Layout location={location} className="overflow-x-hidden break-all">
      ...
      <div>
        ...
        <div className="w-11/12 contact-wrapper mx-auto border border-gray-700 rounded-lg">
          <div className="p-3">
            <p className="pb-3 text-themeGray-200 text-sm lg:text-lg font-Montserrat text-left">
            ...
            <p className="pb-3 text-themeGray-200 text-lg font-Montserrat text-left">
              Thank you.
            </p>
            <h3 className="pb-3 text-themeGray-200 text-sm lg:text-lg font-Montserrat font-bold text-left">
