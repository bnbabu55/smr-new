    ...
    <Layout>
      ...
      <div className="w-11/12 mx-auto pt-20 pb-10">
        <div className="wrapper">
          ...
          <p className="w-4/5 px-4 py-5 text-themeGray-200 text-lg font-Raleway text-center mx-auto">
          ...
          <h2 className="text-themeOrange-400 pt-10 text-4xl font-Raleway font-bold tracking-wide text-center underline">
          ...
          <p className="w-4/5 mx-auto px-4 py-5 text-themeGray-200 text-lg font-Raleway text-center">
